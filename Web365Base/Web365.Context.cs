...
namespace Web365Base
{
    ...
    public partial class Entities365 : DbContext
    {
        ...
        public DbSet<tblTypeVideo> tblTypeVideo { get; set; }
        ...
        public virtual int PRC_ResetFileProduct1(Nullable<int> productID, string listID)
        {
            var productIDParameter = productID.HasValue ?
                new ObjectParameter("ProductID", productID) :
                new ObjectParameter("ProductID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PRC_ResetFileProduct1", productIDParameter, listIDParameter);
        }
    
        public virtual int PRC_ResetPictureArticle1(Nullable<int> articleID, string listID)
        {
            var articleIDParameter = articleID.HasValue ?
                new ObjectParameter("ArticleID", articleID) :
                new ObjectParameter("ArticleID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PRC_ResetPictureArticle1", articleIDParameter, listIDParameter);
        }
    }
}
