...
web365app.factory('productGroupAttributeService', ['$q', '$http', function ($q, $http) {
    ...
    var _getList = function (obj) {
        ...
        $http.get('/admin/ProductGroupAttribute/GetList', {
            params: obj
    ...
    var _getListForTree = function (obj) {
        ...
        //get data from services
        $http.get('/admin/ProductGroupAttribute/GetListForTree').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getListByProductType = function (typeId) {
        ...
        //get data from services
        $http.get('/admin/ProductGroupAttribute/GetListByProductType',{
            params: {
                typeId: typeId
            }
        }).success(function (data) {
    ...
    var _getDetailForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/ProductGroupAttribute/Detail', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _getEditForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/ProductGroupAttribute/EditForm', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _modified = function (obj) {
        ...
        //get data from services
        $http.post('/admin/ProductGroupAttribute/Action', obj, {
    ...
    var _showAll = function (listId) {
        ...
        $http.post('/admin/ProductGroupAttribute/ShowAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _hideAll = function (listId) {
        ...
        $http.post('/admin/ProductGroupAttribute/HideAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _deleteAll = function (listId) {
        ...
        $http.post('/admin/ProductGroupAttribute/Delete', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
