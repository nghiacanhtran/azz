...
web365app.factory('pictureService', ['$q', '$http', function ($q, $http) {
    ...
    var _getList = function (obj) {
        ...
        $http.get('/admin/Picture/GetList', {
            params: obj
	...
	var _getPropertyFilter = function () {
        ...
        //get data from services
        $http.get('/admin/Picture/GetPropertyFilter').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getListByArrayID = function (obj) {
        ...
        //get data from services
        $http.get('/admin/Picture/GetListByArrayID', {
            params: {
                arrID: obj
            }
        }).success(function (data) {
    ...
    var _getEditForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/Picture/EditForm', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _modified = function (obj) {
        ...
        //get data from services
        $http.post('/admin/Picture/Action', obj, {
    ...
    var _showAll = function (listId) {
        ...
        $http.post('/admin/Picture/ShowAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _hideAll = function (listId) {
        ...
        $http.post('/admin/Picture/HideAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _deleteAll = function (listId) {
        ...
        $http.post('/admin/Picture/Delete', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
