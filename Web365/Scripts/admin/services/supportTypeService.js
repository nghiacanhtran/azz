...
web365app.factory('supportTypeService', ['$q', '$http', function ($q, $http) {
    ...
    var _getList = function (obj) {
        ...
        $http.get('/admin/SupportType/GetList', {
            params: obj
    ...
    var _getListForTree = function (obj) {
        ...
        //get data from services
        $http.get('/admin/SupportType/GetListForTree').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getDetailForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/SupportType/Detail', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _getEditForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/SupportType/EditForm', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _modified = function (obj) {
        ...
        //get data from services
        $http.post('/admin/SupportType/Action', obj, {
    ...
    var _showAll = function (listId) {
        ...
        $http.post('/admin/SupportType/ShowAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _hideAll = function (listId) {
        ...
        $http.post('/admin/SupportType/HideAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _deleteAll = function (listId) {
        ...
        $http.post('/admin/SupportType/Delete', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
