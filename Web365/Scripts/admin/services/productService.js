...
web365app.factory('productService', ['$q', '$http', function ($q, $http) {
    ...
    var _getListForTree = function () {
        ...
        //get data from services
        $http.get('/admin/Product/GetListForTree').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getPropertyFilter = function () {
        ...
        //get data from services
        $http.get('/admin/Product/GetPropertyFilter').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getEditForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/Product/EditForm', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _getEditFormFilter = function (id) {
        ...
        //get data from services
        $http.get('/admin/Product/EditFormFilter', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _modified = function (obj) {
        ...
        //get data from services
        $http.post('/admin/Product/Action', obj, {
    ...
    var _showAll = function (listId) {
        ...
        $http.post('/admin/Product/ShowAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _hideAll = function (listId) {
        ...
        $http.post('/admin/Product/HideAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _nameExist = function (id, name) {
        ...
        $http.post('/admin/Product/NameExist', {
            id: id,
            name: name
        }).success(function (data) {
            deferred.resolve(data);
    ...
    var _addFilter = function (obj) {
        ...
        $http.post('/admin/Product/AddFilter', obj, {
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
