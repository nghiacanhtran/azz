...
web365app.factory('productAttributeService', ['$q', '$http', function ($q, $http) {
    ...
    var _getList = function (obj) {
        ...
        $http.get('/admin/ProductAttribute/GetList', {
            params: obj
    ...
    var _getListForTree = function (obj) {
        ...
        //get data from services
        $http.get('/admin/ProductAttribute/GetListForTree').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getListByProductType = function (typeId, productId) {
        ...
        //get data from services
        $http.get('/admin/ProductAttribute/GetListByProductType', {
            params: {
                typeId: typeId,
                productId: productId
            }
    ...
    var _getDetailForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/ProductAttribute/Detail', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _getEditForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/ProductAttribute/EditForm', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _modified = function (obj) {
        ...
        //get data from services
        $http.post('/admin/ProductAttribute/Action', obj, {
    ...
    var _showAll = function (listId) {
        ...
        $http.post('/admin/ProductAttribute/ShowAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _hideAll = function (listId) {
        ...
        $http.post('/admin/ProductAttribute/HideAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _deleteAll = function (listId) {
        ...
        $http.post('/admin/ProductAttribute/Delete', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _addProductAttribute = function (obj) {
        ...
        //get data from services
        $http.post('/admin/ProductAttribute/AddProductAttribute', obj, {
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
