...
web365app.factory('articleTypeService', ['$q', '$http', function ($q, $http) {
    ...
    var _getList = function (obj) {
        ...
        $http.get('/admin/ArticleType/GetList', {
            params: obj
    ...
    var _getListOfGroup = function (groupId) {
        ...
        //get data from services
        $http.get('/admin/ArticleType/GetListOfGroup', {
            params: {
                groupId: groupId
            }
        }).success(function (data) {
    ...
    var _getListForTree = function (obj) {
        ...
        //get data from services
        $http.get('/admin/ArticleType/GetListForTree').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getDetailForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/ArticleType/Detail', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _getEditForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/ArticleType/EditForm', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _modified = function (obj) {
        ...
        //get data from services
        $http.post('/admin/ArticleType/Action', obj, {
    ...
    var _showAll = function (listId) {
        ...
        $http.post('/admin/ArticleType/ShowAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _hideAll = function (listId) {
        ...
        $http.post('/admin/ArticleType/HideAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _deleteAll = function (listId) {
        ...
        $http.post('/admin/ArticleType/Delete', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
