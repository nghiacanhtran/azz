...
web365app.factory('layoutContentService', ['$q', '$http', 'baseService', function ($q, $http, baseService) {
    ...
    var _getList = function (obj) {
        ...
        $http.get('/admin/LayoutContent/GetList', {
            params: obj
    ...
    var _getListForTree = function () {
        ...
        //get data from services
        $http.get('/admin/LayoutContent/GetListForTree').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getPropertyFilter = function () {
        ...
        //get data from services
        $http.get('/admin/LayoutContent/GetPropertyFilter').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getDetailForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/LayoutContent/Detail', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _getEditForm = function (id) {
        ...
        //get data from services
        $http.get('/admin/LayoutContent/EditForm', {
            params: {
                id: id
            }
        }).success(function (data) {
    ...
    var _modified = function (obj) {
        ...
        //get data from services
        $http.post('/admin/LayoutContent/Action', obj, {
    ...
    var _showAll = function (listId) {
        ...
        $http.post('/admin/LayoutContent/ShowAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _hideAll = function (listId) {
        ...
        $http.post('/admin/LayoutContent/HideAll', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _deleteAll = function (listId) {
        ...
        $http.post('/admin/LayoutContent/Delete', {
            listId: listId
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
    ...
    var _nameExist = function (id, name) {
        ...
        $http.post('/admin/LayoutContent/NameExist', {
            id: id,
            name: name
        }).success(function (data) {
            deferred.resolve(data);
