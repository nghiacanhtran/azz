...
web365app.factory('videoService', ['$q', '$http', function ($q, $http) {
    ...
    var _getPropertyFilter = function () {
        ...
        //get data from services
        $http.get('/admin/video/GetPropertyFilter').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _getListByArrayID = function (obj) {
        ...
        //get data from services
        $http.get('/admin/video/GetListByArrayID', {
            params: {
                arrID: obj
            }
        }).success(function (data) {
    ...
    var _getListForTree = function (obj) {
        ...
        //get data from services
        $http.get('/admin/video/GetListForTree').success(function (data) {
            deferred.resolve(data);
        }).error(function (err, status) {
            deferred.reject(err);
        });
    ...
    var _modified = function (obj) {
        ...
        //get data from services
        $http.post('/admin/video/Action', obj, {
